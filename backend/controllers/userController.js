 ...
 * @access  Public
 */
const authUser = asyncHandler(asyncHandler(async (req, res) => {
 ...
 * @access  Private
 */
const updateUserProfile = asyncHandler(asyncHandler(async (req, res) => {
    const user = await User.findById(req.user._id)
 ...
 */
const getUsers = asyncHandler(asyncHandler(async (req, res) => {
 ...
 * @access  Private/Admin
 */
const deleteUser = asyncHandler(asyncHandler(async (req, res) => {
